...
def compute_exec_params_func(
    ...
    fineweb_quality_frac_line_punct_cname: str,
    ...
    return {
        ...
        "fineweb_quality_frac_line_punct_cname": fineweb_quality_frac_line_punct_cname,
...
def fineweb_quality_annotator(
    ...
    fineweb_quality_frac_line_punct_cname: str = "frac_line_punct",
