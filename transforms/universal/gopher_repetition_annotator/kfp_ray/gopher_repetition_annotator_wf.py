...
def compute_exec_params_func(
    ...
    gopher_repetition_dup_line_char_frac_cname: str,
    gopher_repetition_dup_para_char_frac_cname: str,
    gopher_repetition_top_2_grams_cname: str,
    gopher_repetition_top_3_grams_cname: str,
    gopher_repetition_top_4_grams_cname: str,
    gopher_repetition_dup_5_grams_cname: str,
    gopher_repetition_dup_6_grams_cname: str,
    gopher_repetition_dup_7_grams_cname: str,
    gopher_repetition_dup_8_grams_cname: str,
    gopher_repetition_dup_9_grams_cname: str,
    gopher_repetition_dup_10_grams_cname: str,
    gopher_repetition_normalize_string: bool,
) -> dict:
    ...
    return {
        ...
        "gopher_repetition_dup_line_char_frac_cname": gopher_repetition_dup_line_char_frac_cname,
        "gopher_repetition_dup_para_char_frac_cname": gopher_repetition_dup_para_char_frac_cname,
        "gopher_repetition_top_2_grams_cname": gopher_repetition_top_2_grams_cname,
        "gopher_repetition_top_3_grams_cname": gopher_repetition_top_3_grams_cname,
        "gopher_repetition_top_4_grams_cname": gopher_repetition_top_4_grams_cname,
        "gopher_repetition_dup_5_grams_cname": gopher_repetition_dup_5_grams_cname,
        "gopher_repetition_dup_6_grams_cname": gopher_repetition_dup_6_grams_cname,
        "gopher_repetition_dup_7_grams_cname": gopher_repetition_dup_7_grams_cname,
        "gopher_repetition_dup_8_grams_cname": gopher_repetition_dup_8_grams_cname,
        "gopher_repetition_dup_9_grams_cname": gopher_repetition_dup_9_grams_cname,
        "gopher_repetition_dup_10_grams_cname": gopher_repetition_dup_10_grams_cname,
        "gopher_repetition_normalize_string": gopher_repetition_normalize_string,
    }
...
TASK_NAME: str = "gopher_repetition_annotator"

# Pipeline to invoke execution on remote resource
@dsl.pipeline(
    name=TASK_NAME + "-ray-pipeline",
    description="Pipeline for gopher_repetition_annotator Task",
)
def gopher_repetition_annotator(
    # Ray cluster
    ray_name: str = "gopher_repetition_annotator-kfp-ray",  # name of Ray cluster
    ...
    gopher_repetition_dup_para_frac_cname: str = "dup_para_frac",
    gopher_repetition_dup_line_char_frac_cname: str = "dup_line_char_frac",
    gopher_repetition_dup_para_char_frac_cname: str = "dup_para_char_frac",
    gopher_repetition_top_2_grams_cname: str = "top_2_grams",
    gopher_repetition_top_3_grams_cname: str = "top_3_grams",
    gopher_repetition_top_4_grams_cname: str = "top_4_grams",
    gopher_repetition_dup_5_grams_cname: str = "top_5_grams",
    gopher_repetition_dup_6_grams_cname: str = "top_6_grams",
    gopher_repetition_dup_7_grams_cname: str = "top_7_grams",
    gopher_repetition_dup_8_grams_cname: str = "top_8_grams",
    gopher_repetition_dup_9_grams_cname: str = "top_9_grams",
    gopher_repetition_dup_10_grams_cname: str = "top_10_grams",
    gopher_repetition_normalize_string: bool = False,
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5, "delete_cluster_delay_minutes": 0}',
):
    """
    Pipeline to execute gopher_repetition_annotator transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(gopher_repetition_annotator, __file__.replace(".py", ".yaml"))