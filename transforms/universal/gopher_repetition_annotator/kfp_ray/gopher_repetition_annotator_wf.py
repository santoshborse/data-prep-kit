...
def compute_exec_params_func(
    ...
    runtime_job_id: str,
    gra_contents_column_name: str,
    gra_dup_line_frac_cname: str,
    gra_dup_para_frac_cname: str,
    gra_dup_line_char_frac_cname: str,
    gra_dup_para_char_frac_cname: str,
    gra_top_2_grams_cname: str,
    gra_top_3_grams_cname: str,
    gra_top_4_grams_cname: str,
    gra_dup_5_grams_cname: str,
    gra_dup_6_grams_cname: str,
    gra_dup_7_grams_cname: str,
    ...
    return {
        ...
        "gra_contents_column_name": gra_contents_column_name,
        "gra_dup_line_frac_cname": gra_dup_line_frac_cname,
        "gra_dup_para_frac_cname": gra_dup_para_frac_cname,
        "gra_dup_line_char_frac_cname": gra_dup_line_char_frac_cname,
        "gra_dup_para_char_frac_cname": gra_dup_para_char_frac_cname,
        "gra_top_2_grams_cname": gra_top_2_grams_cname,
        "gra_top_3_grams_cname": gra_top_3_grams_cname,
        "gra_top_4_grams_cname": gra_top_4_grams_cname,
        "gra_dup_5_grams_cname": gra_dup_5_grams_cname,
        "gra_dup_6_grams_cname": gra_dup_6_grams_cname,
        "gra_dup_7_grams_cname": gra_dup_7_grams_cname,
...
def gopher_repetition_annotator(
    ...
    gra_contents_column_name: str = "contents",
    gra_dup_line_frac_cname: str = "dup_line_frac",
    gra_dup_para_frac_cname: str = "dup_para_frac",
    gra_dup_line_char_frac_cname: str = "dup_line_char_frac",
    gra_dup_para_char_frac_cname: str = "dup_para_char_frac",
    gra_top_2_grams_cname: str = "top_2_grams",
    gra_top_3_grams_cname: str = "top_3_grams",
    gra_top_4_grams_cname: str = "top_4_grams",
    gra_dup_5_grams_cname: str = "top_5_grams",
    gra_dup_6_grams_cname: str = "top_6_grams",
    gra_dup_7_grams_cname: str = "top_7_grams",
