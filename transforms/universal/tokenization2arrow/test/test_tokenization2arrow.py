...
from dpk_tokenization2arrow.transform import Tokenization2ArrowTransform
...
class TestTokenization2ArrowTransform(AbstractTableTransformTest):
    """
    ...
    def get_test_transform_fixtures(self) -> list[Tuple]:
        ...
        fixtures = [
            (Tokenization2ArrowTransform(config), [table], [expected_table], expected_metadata_list),
        ]
        return fixtures
