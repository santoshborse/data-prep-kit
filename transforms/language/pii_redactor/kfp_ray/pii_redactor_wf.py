...
TASK_NAME: str = "pii_redactor"


@dsl.pipeline(
    name=TASK_NAME + "-ray-pipeline",
    description="Pipeline for pii_redactor",
)
def pii_redactor(
    # Ray cluster
    ...
    with dsl.ExitHandler(clean_up_task):
        ...
        execute_job = execute_ray_jobs_op(
            ...
            run_id=run_id,
            additional_params=additional_params,
            # note that the parameters below are specific for pii_redactor transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(pii_redactor, __file__.replace(".py", ".yaml"))
