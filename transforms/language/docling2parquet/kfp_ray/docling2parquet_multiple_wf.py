...
task_image = "quay.io/dataprep1/data-prep-kit/docling2parquet-ray:latest"

# The secret name containing the s3 credentials.
S3_SECRET = "s3-secret"

# the name of the job script
EXEC_SCRIPT_NAME: str = "-m dpk_docling2parquet.ray.transform"
...
def compute_exec_params_func(
    ...
    docling2parquet_ocr_engine: str,
    docling2parquet_bitmap_area_threshold: float,
) -> dict:
    ...
    return {
        ...
        "docling2parquet_ocr_engine": docling2parquet_ocr_engine,
        "docling2parquet_bitmap_area_threshold": docling2parquet_bitmap_area_threshold,
    }
...
TASK_NAME: str = "docling2parquet"


@dsl.pipeline(
    name=TASK_NAME + "-ray-pipeline",
    description="Pipeline for multiple docling2parquet",
)
def docling2parquet(
    # Ray cluster
    ray_name: str = "docling2parquet-kfp-ray",  # name of Ray cluster
    ...
    # data access
    data_s3_config: str = "[{'input_folder': 'test/docling2parquet/input/', 'output_folder': 'test/docling2parquet/output/'}]",
    ...
    docling2parquet_do_ocr: bool = False,
    docling2parquet_ocr_engine: str = "easyocr",
    docling2parquet_bitmap_area_threshold: float = 0.05,
    # additional parameters
    additional_params: str = '{"wait_interval": 2, "wait_cluster_ready_tmout": 400, "wait_cluster_up_tmout": 300, "wait_job_ready_tmout": 400, "wait_print_tmout": 30, "http_retries": 5, "delete_cluster_delay_minutes": 0}',
):
    """
    Pipeline to execute docling2parquet transform
    ...
    :param docling2parquet_ocr_engine - which ocr engine
    :param docling2parquet_bitmap_area_threshold - threshold for bitmaps
    :return: None
    """
    ...
    with dsl.ExitHandler(clean_up_task):
        ...
        execute_job = execute_ray_jobs_op(
            ...
            run_id=run_id,
            additional_params=additional_params,
            # note that the parameters below are specific for docling2parquet transform
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(docling2parquet, __file__.replace(".py", ".yaml"))
