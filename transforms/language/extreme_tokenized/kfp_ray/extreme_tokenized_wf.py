...
task_image = "quay.io/dataprep1/data-prep-kit/extreme_tokenized-ray:latest"

# The secret name containing the s3 credentials.
S3_SECRET = "s3-secret"

# the name of the job script
EXEC_SCRIPT_NAME: str = "-m dpk_extreme_tokenized.ray.runtime"
# components
...
TASK_NAME: str = "extreme_tokenized"


@dsl.pipeline(
    name=TASK_NAME + "-ray-pipeline",
    description="Pipeline for extreme_tokenized",
)
...
if __name__ == "__main__":
    ...
    compiler.Compiler().compile(extreme_tokenized, __file__.replace(".py", ".yaml"))
